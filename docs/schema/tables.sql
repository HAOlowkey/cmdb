...
CREATE TABLE IF NOT EXISTS `resource` (
  `id` char(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `vendor` tinyint(1) NOT NULL,
  `region` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `zone` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `create_at` bigint NOT NULL,
  `expire_at` bigint DEFAULT NULL,
  `category` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  ...
  `sync_accout` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `pay_type` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
