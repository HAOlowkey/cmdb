...
type CreateSecretRequest struct {
	...
	// 厂商
	// @gotags: json:"vendor"
	Vendor resource.Vendor `protobuf:"varint,2,opt,name=vendor,proto3,enum=course.cmdb.resource.Vendor" json:"vendor"`
	// 允许同步的区域
	...
	CrendentialType Type `protobuf:"varint,4,opt,name=crendential_type,json=crendentialType,proto3,enum=course.cmdb.secret.Type" json:"crendential_type"`
	// 服务地址, 云商不用填写
	// @gotags: json:"address"
...
type Secret struct {
	...
	// 厂商
	// @gotags: json:"vendor"
	Vendor resource.Vendor `protobuf:"varint,4,opt,name=vendor,proto3,enum=course.cmdb.resource.Vendor" json:"vendor"`
	// 允许同步的区域
	// @gotags: json:"allow_regions"
	AllowRegions []string `protobuf:"bytes,5,rep,name=allow_regions,json=allowRegions,proto3" json:"allow_regions"`
	// 凭证类型
	// @gotags: json:"crendential_type"
	CrendentialType Type `protobuf:"varint,6,opt,name=crendential_type,json=crendentialType,proto3,enum=course.cmdb.secret.Type" json:"crendential_type"`
	// 服务地址, 云商不用填写
	// @gotags: json:"address"
...
var file_apps_secret_pb_secret_proto_rawDesc = []byte{
	...
	0x2f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x63,
	0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65,
	...
	0x74, 0x6f, 0x22, 0xcc, 0x02, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x65, 0x63,
	...
	,
	...
	0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x12,
	0x1d, 0x0a, 0x0a, 0x61, 0x70, 0x69, 0x5f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x70, 0x69, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x21,
	0x0a, 0x0c, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x61, 0x74,
	0x65, 0x22, 0xec, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x08, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x34, 0x0a, 0x06, 0x76,
	...
	,
	...
	0x52, 0x08, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x22, 0x53, 0x0a, 0x09, 0x53, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x53, 0x65, 0x74, 0x12, 0x30, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e,
	0x63, 0x6d, 0x64, 0x62, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74,
	...
	0x21, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x41, 0x50, 0x49, 0x5f, 0x4b,
	0x45, 0x59, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x50, 0x41, 0x53, 0x53, 0x57, 0x4f, 0x52, 0x44,
	0x10, 0x01, 0x32, 0xe2, 0x02, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x53,
	0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x27,
	0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x73, 0x65, 0x63,
	...
	,
	...
	0x63, 0x6d, 0x64, 0x62, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x12, 0x53, 0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x12, 0x27, 0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62,
	0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x63, 0x6f,
	0x75, 0x72, 0x73, 0x65, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74,
	0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_apps_secret_pb_secret_proto_goTypes = []interface{}{
	(Type)(0),                     // 0: course.cmdb.secret.Type
	(*CreateSecretRequest)(nil),   // 1: course.cmdb.secret.CreateSecretRequest
	(*Secret)(nil),                // 2: course.cmdb.secret.Secret
	(*QuerySecretRequest)(nil),    // 3: course.cmdb.secret.QuerySecretRequest
	(*SecretSet)(nil),             // 4: course.cmdb.secret.SecretSet
	(*DescribeSecretRequest)(nil), // 5: course.cmdb.secret.DescribeSecretRequest
	(*DeleteSecretRequest)(nil),   // 6: course.cmdb.secret.DeleteSecretRequest
	(resource.Vendor)(0),          // 7: course.cmdb.resource.Vendor
	(*request.PageRequest)(nil),   // 8: infraboard.mcube.page.PageRequest
}
var file_apps_secret_pb_secret_proto_depIdxs = []int32{
	7,  // 0: course.cmdb.secret.CreateSecretRequest.vendor:type_name -> course.cmdb.resource.Vendor
	0,  // 1: course.cmdb.secret.CreateSecretRequest.crendential_type:type_name -> course.cmdb.secret.Type
	7,  // 2: course.cmdb.secret.Secret.vendor:type_name -> course.cmdb.resource.Vendor
	0,  // 3: course.cmdb.secret.Secret.crendential_type:type_name -> course.cmdb.secret.Type
	8,  // 4: course.cmdb.secret.QuerySecretRequest.page:type_name -> infraboard.mcube.page.PageRequest
	2,  // 5: course.cmdb.secret.SecretSet.items:type_name -> course.cmdb.secret.Secret
	1,  // 6: course.cmdb.secret.Service.CreateSecret:input_type -> course.cmdb.secret.CreateSecretRequest
	3,  // 7: course.cmdb.secret.Service.QuerySecret:input_type -> course.cmdb.secret.QuerySecretRequest
	5,  // 8: course.cmdb.secret.Service.DescribeSecret:input_type -> course.cmdb.secret.DescribeSecretRequest
	6,  // 9: course.cmdb.secret.Service.DeleteSecret:input_type -> course.cmdb.secret.DeleteSecretRequest
	2,  // 10: course.cmdb.secret.Service.CreateSecret:output_type -> course.cmdb.secret.Secret
	4,  // 11: course.cmdb.secret.Service.QuerySecret:output_type -> course.cmdb.secret.SecretSet
	2,  // 12: course.cmdb.secret.Service.DescribeSecret:output_type -> course.cmdb.secret.Secret
	2,  // 13: course.cmdb.secret.Service.DeleteSecret:output_type -> course.cmdb.secret.Secret
